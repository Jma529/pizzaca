...
<div id="page" class="site">
	...
	<header id="masthead" class="header">
		...
		<nav id="site-navigation" class="main-navigation">
			...
			<div class="cart-icon">
		<a class="basketicon" href="<?php echo wc_get_checkout_url(); ?>" title="<?php _e( 'View your shopping cart' ); ?>"> <i class="fa fa-shopping-cart"></i> <?php echo WC()->cart->get_cart_total(); ?></a>
		</div>
		</nav><!-- #site-navigation -->
